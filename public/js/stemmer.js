(function() {
  var Default=["aba", "abad", "abadi", "abadiah", "abah", "abai", "abaimana", "abaka",
  ...
  var Stemmer = (function() {
      ...
      var Stemmer = function(dict=Default) {
          /*start*/
          var dictionary={}
          ...
          var hasPrefix = function(needle, haystack){
              return (haystack.substr(0, needle.length) == needle);
          }


          this.addToDict = function(words){
              words.forEach(function(word) {
                  dictionary[word]="";
              });
          }

          this.remove = function(words){
              words.forEach(function(word) {
          ...
          function removeParticle(word) {
              result = word.replace(/-?(lah|kah|tah|pun)$/g,"")
              particle = word.replace(result,"")
              return [particle, result]
          }


          function removePossesive(word) {
              result = word.replace(/-?(ku|mu|nya)$/g,"")
              possesive = word.replace(result,"")
          ...
          function loopPengembalianAkhiran(originalWord, suffixes) {
              lenSuffixes = 0
              suffixes.forEach(function (suffix, i) {
                  lenSuffixes += suffix.length
              })
              wordWithoutSuffix = originalWord.substring(0,originalWord.length-lenSuffixes)
          ...
          function removePrefix(word){
              var prefix,result,recoding

              if (hasPrefix("di",word) || hasPrefix("ke",word) || hasPrefix("se",word) || hasPrefix("ku",word)) {
          ...
          function removePePrefix(word) {
              ...
              if (isOneOf(s3,consonant) && isNotOneOf(s3,"rwylmn") && isOneOf(s4,"e") && isOneOf(s5,"r") && isOneOf(s6,vowel)) {
                  return [word.substring(3,word.length), null]
              }

              // Pattern 14
              // peCP => pe-CP where C != {r|w|y|l|m|n} and P != 'er'
              if (isOneOf(s3,consonant) && isNotOneOf(s3,"rwylmn") && isNotOneOf(s3,"e")) {
                  return [word.substring(2,word.length), null]
              }

              // Pattern 15
              // peC1erC2 => pe-C1erC2 where C1 != {r|w|y|l|m|n}
              if (isOneOf(s3,consonant) && isNotOneOf(s3,"rwylmn") && isOneOf(s4,"e") && isOneOf(s5,"r") && isOneOf(s6,consonant)) {
                  return [word.substring(2,word.length), null]
              }
          ...
          function removeTePrefix(word) {
              ...
              if (isOneOf(s3,"r") && isOneOf(s4,consonant) && isNotOneOf(s4,"r") && isOneOf(s5,"e") && isOneOf(s6,"r") && isOneOf(s7,vowel)) {
                  return [word.substring(3,word.length), null]
              }

              // Pattern 3
              // terCP => ter-CP where C != 'r' and P != 'er'
              if (isOneOf(s3,"r") && isOneOf(s4,consonant) && isNotOneOf(s4,"r") && isNotOneOf(s5,"e")) {
                  return [word.substring(3,word.length), null]
              }

              // Pattern 04
              // teC1erC2 => te-C1erC2 where C1 != 'r'
              if (isOneOf(s3,consonant) && isNotOneOf(s3,"r") && isOneOf(s4,"e") && isOneOf(s5,"r") && isOneOf(s6,consonant)) {
                  return [word.substring(2,word.length), null]
              }

              // Pattern 05
              // terC1erC2 => ter-C1erC2 where C1 != 'r'
              if (isOneOf(s3,"r") && isOneOf(s4,consonant) && isNotOneOf(s4,"r") && isOneOf(s5,"e") && isOneOf(s6,"r") && isOneOf(s7,consonant)) {
                  return [word.substring(3,word.length), null]
              }
          ...
          function removeInfix(word) {
              ...
              // Pattern 01
              // CerV => CerV OR CV
              if (isOneOf(s1,consonant) && isOneOf(s2,"e") && isOneOf(s3,"rlm") && isOneOf(s4,vowel)) {
                  return [word.substring(3,word.length), [word.substring(0,3), word.substring(0,1)]]
              }

              // Pattern 02
              // CinV => CinV OR CV
              if (isOneOf(s1,consonant) && isOneOf(s2,"i") && isOneOf(s3,"n") && isOneOf(s4,vowel)) {
                  return [word.substring(3,word.length), [word.substring(0,3), word.substring(0,1)]]
              }
